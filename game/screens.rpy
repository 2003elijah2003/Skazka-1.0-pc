...
screen navigation():
    ...
    vbox:
        ...
        textbutton _("Загрузки") action ShowMenu("load")
        ...
        if renpy.variant("pc"):
            ...
            ## Web.
            textbutton _("Уйти") action Quit(confirm=not main_menu)
...
screen file_slots(title):
    ...
    default page_name_value = FilePageNameInputValue(pattern=_("Страница {}"), auto=_("Автосохранение"), quick=_("Быстрое сохранение"))
...
screen keyboard_help():
    ...
    hbox:
        label "V"
        text _("Включает поддерживаемый{a=https://www.renpy.org/l/voicing}self-voicing{/a}.")
